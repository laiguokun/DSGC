...
\begin{itemize}
    ...
    %where hyper-parameters are optimized under marginalized likelihood of data \cite{frigola2015bayesian,roberts2013gaussian}.
...
\begin{itemize}
	...
	\item \electricity \footnote{\url{https://archive.ics.uci.edu/ml/datasets/ElectricityLoadDiagrams20112014}}: The electricity consumption in kWh was recorded every 15 minutes from 2012 to 2014, for n = 321 clients. We converted the data to reflect hourly consumption; %, by aggregating blocks of 4 columns.
